            ...
            <div class="d-flex">
                ...
                <div class="flex-fill px-4" style="margin-left: 20%; max-width: 70%;">
                    <div style="padding: 40px 20px 20px 20px;">
                        <div class="h3" style="padding-left: 10px;">Add Staff</div>
                    </div>
                    <div class="container py-4 px-4 bg-light col-5 m-0" style="border-radius: 10px;">
                        <form method="POST" action="adminAddStaffServlet">
                            <div class="row" style="gap: 20px;">
                                ...
                                <div class="col-12">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-8">
                                            <input type="password" class="form-control-input border-0" id="name" name="password"/>
                                        </div>
                                    </div>
