            ...
            <div class="d-flex">
                ...
                <div class="flex-fill px-4" style="margin-left: 20%; max-width: 70%;">
                    <div style="padding: 40px 20px 20px 20px;">
                        <div class="h3" style="padding-left: 10px;">Add Product</div>
                    </div>
                    <div class="container py-4 px-4 bg-light" style="border-radius: 10px;">
                        <form method="POST" action="adminAddProductServlet" enctype='multipart/form-data'>
                            <div class="row" style="gap: 20px;column-gap: 10%;">
                                <div class="col-5">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-8">
                                            <input type="text" class="form-control-input border-0" id="name" name="name"  required/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-5">
                                ...
                                <div class="col-5">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-8">
                                            <input type="number" step="0.01" class="form-control-input border-0" min="10" id="price" name="price"  required/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-5">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-8">
                                            <input type="number" class="form-control-input border-0" min="10" id="stock" name="stock" required/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-5">
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <textarea class="form-control-input border-0 w-100" id="description" name="description" style="min-height: 79px"  required></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-5">
                            ...
                            <div class="modal fade" id="categories-modal" tabindex="-1" aria-labelledby="categories-modal" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <%for (int i = 0; i < categories.size(); i++) {
                                                int id = (int) categories.get(i).getCategoryid();
                                            %>
                                            <div class="d-flex py-2 px-5" style="gap:10px;">
                                                <input class="form-control-checkbox" type="checkbox" id="<%=id%>" name="category" value="<%=id%>">
                                                <label class="noselect" for="<%=id%>"><%=categories.get(i).getCategoryname()%></label>
                                            </div>
                                            <%}%>
                                        </div>
